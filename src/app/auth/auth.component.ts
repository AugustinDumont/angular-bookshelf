...
export class AuthComponent implements OnInit {
  ...
  logIn() {
    let request = new Promise((resolve, reject) => {
      ...
      let logPass = (<HTMLInputElement>document.getElementById("logPass"))
        .value;
  ...
  registerUser() {
    let request = new Promise((resolve, reject) => {
      ...
      let regName = (<HTMLInputElement>document.getElementById("regName"))
        .value;

      let regPass = (<HTMLInputElement>document.getElementById("password"))
        .value;
      ...
      setTimeout(() => {
        if (this.AuthService.report !== undefined) {
          ...
          if (
            ...
            document.getElementById("regError").textContent =
              "Error : your passwords are not identical.";
          }
