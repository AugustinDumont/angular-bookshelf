...
export class LibraryComponent implements OnInit {
  ...
  constructor(
    apollo: Apollo,
    private QueriesService: QueriesServices,
  ...
  formProcess() {
    ...
    let editor = String(
      (<HTMLInputElement>document.getElementById("editor")).value
    );
    let cover = String(
    ...
    let school = String(
      (<HTMLSelectElement>document.getElementById("school")).value
    );
    ...
    if (
      ...
      let request = new Promise((resolve, reject) => {
        this.QueriesService.books = "wait";
        // Asking to the service for use getBooks function.
        this.books = this.QueriesService.postBooks(
          this.apollo,
          isbn,
          title,
          author,
        ...
        setTimeout(() => {
          ...
          if (this.QueriesService.books !== "wait") {
            validate.innerHTML =
              validate.innerHTML + " Book successfully submited.";
      ...
      if (isbn === "") {
        report.innerHTML =
          report.innerHTML + "<br> Error : Missing field isbn.";
      }

      if (title === "") {
        report.innerHTML =
          report.innerHTML + "<br> Error : Missing field title.";
      }

      if (author === "") {
        report.innerHTML =
          report.innerHTML + "<br> Error : Missing field author.";
      }

      if (editor === "") {
        report.innerHTML =
          report.innerHTML + "<br> Error : Missing field editor.";
      }

      if (cover === "") {
        report.innerHTML =
          report.innerHTML + "<br> Error : Missing field cover";
      }

      if (lang === "") {
        report.innerHTML =
          report.innerHTML + "<br> Error : Missing field language";
      }

      if (school === "") {
        report.innerHTML =
          report.innerHTML + "<br> Error : Missing field school";
      }
    }
  ...
  filterProcess() {
    ...
    let val = String(
      (<HTMLSelectElement>document.getElementById("filterSchool")).value
    );
  ...
  filterLangProcess() {
    ...
    let val = String(
      (<HTMLSelectElement>document.getElementById("filterLang")).value
    );
    console.log(val);
    this.filteredBooks = [];
  ...
  filterAvailableProcess() {
    ...
    let val = String(
      (<HTMLSelectElement>document.getElementById("filterAvailable")).value
    );
